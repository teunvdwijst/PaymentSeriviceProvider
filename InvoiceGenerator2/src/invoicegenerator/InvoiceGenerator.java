...
public class InvoiceGenerator extends Application {
    ...
    final AppGateway gateway = new AppGateway("Client2ToPSP", "PSPToClient2");
    ...
    private final String generatedBy = "Client2";
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("InvoiceGenerator Client2");
